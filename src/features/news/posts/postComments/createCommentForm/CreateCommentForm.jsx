...
const CreateCommentForm = props => {
  ...
  const formWrapperClassName = classNames(
    'w-full border-2 flex items-center rounded-[20px] mb-4 pl-4 box-border bg-white',
    {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className={formWrapperClassName}>
        <TextareaAutosize
          className="h-full max-h-[200px] max-w-[70%] w-full py-2 text-justify overflow-x-hidden overflow-y-auto focus-visible:outline-0 resize-none border-0 focus:ring-0
                     md:max-w-[80%]
                     2xl:max-w-[90%]"
          {...register('body')}
        ...
        />
        <div
          className="flex justify-center items-center max-w-[30%] w-full flex-col border-l-2
                     md:max-w-[20%]
                     2xl:max-w-[10%]"
        >
